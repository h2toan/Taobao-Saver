...
function writeToDatabase(PAYLOAD = TEST_PAYLOAD) {
    ...
    const VARIABLE1 = ITEM_VARIATION.map(e => [checkText(e.variable1Name), checkText(e.variable1Value)]);
    const VARIABLE2 = ITEM_VARIATION.map(e => [checkText(e.variable2Name), checkText(e.variable2Value)]);
